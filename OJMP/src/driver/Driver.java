...
/**
 * This is the entry class to the application. It takes as input the mode flag which the jar is required to run.
...
public class Driver {
	 ...
	 * @param args This string array must contain only one element which must be "server", "alone" or blank.
	 */
	public static void main(String[] args) {
		...
		if (args.length > 1)
		{
			System.out.println("Please enter either \"alone\", \"server\", or leave blank for networked client");
			System.exit(0);
		}
