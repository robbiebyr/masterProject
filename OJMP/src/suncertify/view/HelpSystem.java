...
/**
 * This class is used to display a step by step guide to searching & booking a
 * record.
 * 
 * @author Robbie Byrne
 * 
...
public class HelpSystem extends JFrame {
	...
	/**
	 * All the components of the GUI are created in this zero argument
	 * constructor.
	 */
	public HelpSystem() {
	...
	class InfoListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			picture.setIcon(new ImageIcon(this.getClass().getResource(
					"/Info" + selection + ".png")));
