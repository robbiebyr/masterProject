...
/**
 * This class is used to get RMI details from the user in order to create the
 * required server. A JFrame is displayed with three fields corresponding to db
 * file location, hostname and port of the server.
 * 
 * @author Robbie Byrne
 * 
 */
