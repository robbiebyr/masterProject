...
/**
 * This interface is identical to the DBMain interface except all the methods also throw RemoteException.
 * @author Robbie Byrne
 *
 */
public interface DBMainRemote extends Remote {
	...
	/**
	 * This method modifies the fields of a record. The new value for field n appears in data[n].
	 * @param recNo Number of record
	 * @param data String array containing field values of a record.
	 * @throws RecordNotFoundException Thrown if the record number could not be found.
	 * @throws RemoteException Thrown if there is a client-server network issue.
	 */
	...
	/**
	 * This method returns an int array corresponding to records which match the search
	 * criteria based on name and location.
	 * @param criteria String array containing search criteria.
	 ...
	 * @throws DuplicateKeyException Never thrown in this application.
	 * @throws RemoteException Thrown if there is a client-server network issue.
	 */
	public int create(String[] data) throws DuplicateKeyException, RemoteException;

	/**
	 * This method locks a record so that it can only be updated or deleted by this client.
	 * @param recNo Number of record.
	 * @throws RecordNotFoundException Thrown if the record number could not be found.
	 * @throws RemoteException Thrown if there is a client-server network issue.
	 */
